...
impl<'a> Page<'a> {
    ...
    pub fn view<Ms>(&self, view_page: ViewPage<'a, Ms>, viewer: Option<&Viewer>) -> Vec<Node<Ms>> {
        ...
        vec![
            div![
                class!["grid-y grid-frame"],
                self.view_header(viewer),
                div![
                    class!["medium-cell-block-container"],
    ...
    fn view_footer<Ms>(&self) -> Node<Ms> {
        footer![div![
            ...
            span![
                ...
                a![attrs! {At::Href => "https://snipey.dev"}, "Odin Media"],
